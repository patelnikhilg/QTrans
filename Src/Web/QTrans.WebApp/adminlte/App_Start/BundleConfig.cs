    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/lib")
                ...
                .Include(ltecomponents + "datatables.net-bs/js/dataTables.select.min.js")
            ...
            bundles.Add(new StyleBundle("~/Content/css")
                ...
                .Include(ltecomponents + "datatables.net-bs/css/select.dataTables.min.css")
            ...
            bundles.Add(new StyleBundle("~/Content/sweetCss")
